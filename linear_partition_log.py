...
def main():
    ...
    for seq in test_sequences:
        ...
        print(f"Bottom-Up     Q(x) = {partition_bu_log(seq)}")
        print(f"Left to Right Q(x) = {partition_lr_log(seq)}")
        print(f"Beam Pruning  Q(x, b=1) = {linear_partition_log(seq, 1)}")
        print(f"Beam Pruning  Q(x, b=3) = {linear_partition_log(seq, 3)}")
        print(f"Beam Pruning  Q(x, b=5) = {linear_partition_log(seq, 5)}")
        print(f"Beam Pruning  Q(x, b=10) = {linear_partition_log(seq, 10)}")
        print(f"Beam Pruning  Q(x, b=50) = {linear_partition_log(seq, 50)}")
        print("")
