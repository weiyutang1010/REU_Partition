...
def main():
    ...
    for seq in test_sequences:
        ...
        print(f"Bottom-Up     Q(x) = {partition_bu(seq)}")
        print(f"Left to Right Q(x) = {partition_lr(seq)}")
        print(f"Beam Pruning  Q(x, b=1) = {linear_partition(seq, 1)}")
        print(f"Beam Pruning  Q(x, b=3) = {linear_partition(seq, 3)}")
        print(f"Beam Pruning  Q(x, b=5) = {linear_partition(seq, 5)}")
        print(f"Beam Pruning  Q(x, b=10) = {linear_partition(seq, 10)}")
        print(f"Beam Pruning  Q(x, b=50) = {linear_partition(seq, 50)}")
        print("")
